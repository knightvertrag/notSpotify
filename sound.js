var sound1 = new Howl({
    src: ['./songs/The_Script_-_Six_Degrees_of_Separation_Official_Video[GrabvidtoMp3.com].mp3'],
    preload : true,
    volume: 0.5
});
var sound2 = new Howl({
    src: ['./songs/The_Script_-_If_You_Could_See_Me_Now_Official_Video[GrabvidtoMp3.com].mp3'],
    preload : true,
    volume: 0.5
});
var sound3 = new Howl({
